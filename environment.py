...
class Environment(object):
    ...
    def update_env(self, direction, energy_ai, month):
        ...
        scaled_temperature_ai = (self.temperature_ai - self.min_temperature) / (self.max_temperature - self.temperature_ai)
        scaled_number_users = (self.current_number_users - self.min_number_users) / (self.max_number_users -self.current_number_users)
        scaled_rate_data = (self.current_rate_data - self.min_rate_data) / (self.max_rate_data - self.current_rate_data)
